...
IANA_PORT_TABLE_URL: str = "https://www.iana.org/assignments"
IANA_PORT_TABLE_URL += "/service-names-port-numbers/service-names-port-numbers"
IANA_PORT_TABLE_URL += ".csv"
